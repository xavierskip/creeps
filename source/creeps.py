...
class Game(object):
    ...
    def run(self):
        ...
        while 1:
            ...
            if self.STATE == 0:
                ...
                self.message_board.blit(self.font.render(u'用鼠标点击选择初始位置,方向键控制方向，「p」键暂停，「ESC」键退出。',True,self.FONT_COLOR),(7,10))
                self.message_board.blit(self.font.render(u'「回车键」开始游戏',True,self.FONT_COLOR),(7,40))
    ...
    def draw_message(self):
        self.message_board.blit(self.font.render(u'Time: %.2fs' %self.get_play_time(),True,self.FONT_COLOR),(7,10))
    ...
    def game_over(self):
        self.STATE = -1
        self.paused = not self.paused
        self.message_board.blit(self.font.render(u'「回车键」重新开始游戏',True,self.FONT_COLOR),(47,40))
        self.message_board.blit(self.font.render(u'GAME OVER  ┑(￣。￣)┍',True,(255,0,0)),(350,10))
